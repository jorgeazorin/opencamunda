...
public class ZeebeLinkedResourcesImpl extends BpmnModelElementInstanceImpl
  ...
  protected static ChildElementCollection<ZeebeLinkedResource> linkedResourcesCollection;
  ...
  public Collection<ZeebeLinkedResource> getLinkedResources() {
    return linkedResourcesCollection.get(this);
  }
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    ...
    linkedResourcesCollection =
        typeBuilder.sequence().elementCollection(ZeebeLinkedResource.class).build();
